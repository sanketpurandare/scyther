...
from comm_analysis import estimate_nccl_collective_lat_and_bw, NCCL_COLL, NCCL_HW, NCCL_PROTO, NCCL_ALGO
...
if __name__ == "__main__":
    ...
    all_gather_latency, all_gather_bw = get_collective_latency_bandwidth(NCCL_COLL.ALL_GATHER, world_size, num_gpus_per_node)
    all_gather_time = all_gather_latency + (tensor_size / all_gather_bw)
    print(f"All Gather time for Tensor Size {tensor_size} B is {all_gather_time:.3f} ms")
